# Cleaning Dirty Data Samples using Power Query

This repository contains Six different messy datasets, each with various data quality issues, such as missing values, incorrect formats, duplicates, and inconsistent entries. cleaned using **Excel Power Query**.
...
## Files Included
- Raw dirty data files
- Cleaned Excel files with Power Query steps
- Image files with Applied Steps 
...
## About Me
I am preparing for **MIS Executive / Data Analyst roles** and focus on practical Excel & Power Query skills used in real organizations.
